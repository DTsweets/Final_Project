                                            ...
                                            <td class="action-cell">
                                                <div
                                                    ...
                                                    <button type="button" class="ev-open-btn"
                                                        data-ev="user_item_legacy:<?= $item['id'] ?>:<?= $selected_year ?>"
                                                        onclick="openEvidence({adminItemId:<?= $item['id'] ?>, yearId:<?= $selected_year ?>, title:'หลักฐาน: '+<?= htmlspecialchars(json_encode($item['name_tiem'], JSON_UNESCAPED_UNICODE), ENT_QUOTES) ?>})"
