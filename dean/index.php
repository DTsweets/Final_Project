            ...
            <div style="display:grid;grid-template-columns:320px 1fr;gap:1.5rem;align-items:start;">
                <div class="db-card db-card-white" style="text-align:center;">
                    ...
                    <div style="display:flex;justify-content:center;gap:14px;margin-top:12px;font-size:.85rem;">
                        <span style="color:#F97316;font-weight:700;">■ S1 <?= number_format($sys_scope[1], 0) ?></span>
                        <span style="color:#EC4899;font-weight:700;">■ S2 <?= number_format($sys_scope[2], 0) ?></span>
                        <span style="color:#3B82F6;font-weight:700;">■ S3 <?= number_format($sys_scope[3], 0) ?></span>
                    </div>
                </div>
